...
insert into user_tb (id, username, password, email, phone_number, position, roles, join_date, created_at, updated_at)
values (1, '윤준호', '$2a$10$HM42UGF28HVpYO8X2hDe/eDdOSpNd5tlM1YvEbACJY3ZSGBSCtwce', 'tester01@gmail.com', '01012345678', '사원', 'ROLE_USER', '2023-07-27', '2023-07-27', '2023-07-27');

insert into user_tb (id, username, password, email, phone_number, position, roles,  join_date, created_at, updated_at)
values (2, '곽빈', '$2a$10$HM42UGF28HVpYO8X2hDe/eDdOSpNd5tlM1YvEbACJY3ZSGBSCtwce', 'tester02@gmail.com', '01012345678', '사원', 'ROLE_USER', '2023-07-27', '2023-07-27', '2023-07-27');

insert into user_tb (id, username, password, email, phone_number, position, roles,  join_date, created_at, updated_at)
values (3, '전형근', '$2a$10$HM42UGF28HVpYO8X2hDe/eDdOSpNd5tlM1YvEbACJY3ZSGBSCtwce', 'tester03@gmail.com', '01012345678', '사원', 'ROLE_USER', '2023-07-27', '2023-07-27', '2023-07-27');

insert into user_tb (id, username, password, email, phone_number, position, roles,  join_date, created_at, updated_at)
values (4, '이영하', '$2a$10$HM42UGF28HVpYO8X2hDe/eDdOSpNd5tlM1YvEbACJY3ZSGBSCtwce', 'tester04@gmail.com', '01012345678', '주임', 'ROLE_USER', '2023-07-27', '2022-11-27', '2023-07-27');

insert into user_tb (id, username, password, email, phone_number, position, roles,  join_date, created_at, updated_at)
values (5, '박치국', '$2a$10$HM42UGF28HVpYO8X2hDe/eDdOSpNd5tlM1YvEbACJY3ZSGBSCtwce', 'tester05@gmail.com', '01012345678', '대리', 'ROLE_USER', '2023-07-27', '2022-11-27', '2023-07-27');

insert into user_tb (id, username, password, email, phone_number, position, roles,  join_date, created_at, updated_at)
values (6, '양석환', '$2a$10$HM42UGF28HVpYO8X2hDe/eDdOSpNd5tlM1YvEbACJY3ZSGBSCtwce', 'tester06@gmail.com', '01012345678', '대리', 'ROLE_ADMIN', '2023-07-27', '2022-01-27', '2023-07-27');

insert into user_tb (id, username, password, email, phone_number, position, roles,  join_date, created_at, updated_at)
values (7, '정수빈', '$2a$10$HM42UGF28HVpYO8X2hDe/eDdOSpNd5tlM1YvEbACJY3ZSGBSCtwce', 'tester07@gmail.com', '01012345678', '과장', 'ROLE_USER', '2023-07-27', '2021-07-27', '2023-07-27');

insert into user_tb (id, username, password, email, phone_number, position, roles,  join_date, created_at, updated_at)
values (8, '김재환', '$2a$10$HM42UGF28HVpYO8X2hDe/eDdOSpNd5tlM1YvEbACJY3ZSGBSCtwce', 'tester08@gmail.com', '01012345678', '차장', 'ROLE_USER', '2023-07-27', '2021-06-27', '2023-07-27');

insert into user_tb (id, username, password, email, phone_number, position, roles, join_date, created_at, updated_at)
values (9, '허경민', '$2a$10$HM42UGF28HVpYO8X2hDe/eDdOSpNd5tlM1YvEbACJY3ZSGBSCtwce', 'tester09@gmail.com', '01012345678', '차장', 'ROLE_ADMIN', '2023-07-27', '2020-04-27', '2023-07-27');

insert into user_tb (id, username, password, email, phone_number, position, roles, join_date, created_at, updated_at)
values (10, '양의지', '$2a$10$HM42UGF28HVpYO8X2hDe/eDdOSpNd5tlM1YvEbACJY3ZSGBSCtwce', 'tester10@gmail.com', '01012345678', '부장', 'ROLE_ADMIN', '2023-07-27', '2023-07-27', '2023-07-27');
